...
export const Root = withProvider<HTMLDivElement, Assign<Assign<HTMLStyledProps<'div'>, Accordion.RootBaseProps>, AccordionVariantProps>>(
    Accordion.Root,
    'root'
)
...
export const ItemIndicator = withContext<HTMLDivElement, Assign<HTMLStyledProps<'div'>, Accordion.ItemIndicatorBaseProps>>(
    Accordion.ItemIndicator,
    'itemIndicator'
)

export const Item = withContext<HTMLDivElement, Assign<HTMLStyledProps<'div'>, Accordion.ItemBaseProps>>(Accordion.Item, 'item')

export const ItemTrigger = withContext<HTMLButtonElement, Assign<HTMLStyledProps<'button'>, Accordion.ItemTriggerBaseProps>>(
